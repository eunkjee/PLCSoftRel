...
attr_states = {attribute: State.Low for attribute in attributes}
function_point = 50
complexity = get_complexity(function_point)

# NRC report data
function_point, complexity, attr_states = nrc_report_data(dict(attr_states))
# generic data for fault size distritbution (FSD)
generic_function_point, generic_complexity, generic_attr_states = generic_data(dict(attr_states))
